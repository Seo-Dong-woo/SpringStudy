...
public class FoodController {
	...
	public String food_detail_before(int fno, HttpServletResponse response, RedirectAttributes ra)
	{
		...
		return "redirect:../food/detail.do"; // detail.do?no=값을 안써도 됨. ra.addAttribute("fno", fno);를 했기 때문에
	}
	...
	@RequestMapping("food/find.do") // get, post가 동시에 쓰여져야 해서 @reuqestMapping. 페이지 나누기: get, 검색값 받기: post
	public String food_find(String page, String colname, String ss, Model model) //ss: search string
	{
		if(colname==null)
			colname="type";
		if(ss==null)
