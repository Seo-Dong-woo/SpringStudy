...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//StudentDAO dao=new StudentDAO(); // mapper에 구현된 클래스를 가져와야 하는데 new를 쓰면 NullpointerException
		StudentDAO dao=(StudentDAO)app.getBean("dao"); // app.xml에 있는 id와 일치해야함
