 ...
 *         2. 순수하게 자바만 이용 => @Bean
 *         ==========================================
 *   Data Acess: JDBC/ORM()/(MyBatis, JPA)/JMS/OXM
 *               ========================= Transaction
 *   Web: web/MVC
 *   AOP: 공통 모듈 => Commons~
 ...
 *      ------------------------------------------------
 *      |                                 |            |
 *   GenericXmlApplicationContext     AnnotationConfigpplicationContext
 *                                      => XML없이 사용
 *     => close(): Application
 ...
 *           객체 생성
 *           
 *     => 라이브러리는 자바 소스를 추가할 수 없음
 *        => 라이브러리에서 읽어가는 파일을 생성
 *                     ==========
 *                     1. XML
 *                        => 태그명/속성명이 다르면 인식을 못함
 *                     2. Annotation이 있는 클래스
 *                        => 스프링에서 지원하는 어노테이션만 이용
 */
